...
public class TelaAluno extends JFrame {
	...
	public static void main(String[] args) {
		...
		btnAvaliaes.setForeground(new Color(64, 0, 0));
		btnAvaliaes.setFont(new Font("Tahoma", Font.BOLD, 25));
		btnAvaliaes.setBorder(new MatteBorder(1, 1, 3, 1, (Color) new Color(0, 0, 0)));
		btnAvaliaes.setBackground(Color.WHITE);
		btnAvaliaes.setBounds(154, 527, 450, 39);
