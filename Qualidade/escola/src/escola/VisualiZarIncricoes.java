...
public class VisualiZarIncricoes extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VisualiZarIncricoes frame = new VisualiZarIncricoes();
		...
		lblInserirGuich.setBounds(102, 11, 330, 112);
