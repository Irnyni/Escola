...
public class loginProf extends JFrame {
	...
	public static void main(String[] args) {
		...
		contentPane.setBackground(new Color(48, 24, 24));
		...
		JButton btnNewButton = new JButton("Entrar como aluno");
		...
		lblAluno.setFont(new Font("Javanese Text", Font.BOLD, 99));
		lblAluno.setAutoscrolls(true);
		lblAluno.setAlignmentY(1.0f);
		lblAluno.setBounds(150, 165, 626, 133);
